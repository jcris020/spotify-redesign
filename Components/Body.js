...
function Body({ spotifyApi, chooseTrack }) {
    ...
    return (
        <div className="bg-black ml-24 py-4 space-y-8 md:max-w-6xl flex-growmd:mr-2.5">
            {/* Search Bar */}
            ...
            <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
                ...
                <div className="hidden xl:inline max-w-[270px]">
                    ...
                    <button className="text-[#CECECE] bg-[#1A1A1A] text-[13px] py-3.5 px-4 
                    rounded-xl w-full font-bold bg-opacity-80 hover:bg-oopacity-100 transition 
                    ease-out">
                        All Genres
                    </button>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-3 border-2 border-[#262626] rounded-2xl p-3 bg-[#0D0D0D]
